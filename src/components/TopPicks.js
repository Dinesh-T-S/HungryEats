    ...
    return(
        <>
            ...
            <div className="   lg:flex max-w-[1520px] m-auto py-2 px-2">
                ...
                <Splide  options={{perPage: 3, gap:"0.5rem", grag:'free', arrows:false}}>
                {
                    topPicks.map((item)=>{
                        return(
                            ...
                            <div className=" rounded-3xl relative">
                                ...
                                <img  
                                    className="h-[200px] w-full object-cover rounded-3xl cursor-pointer hove:scale-105 ease-out duration-300" 
                                    src={item.img} 
                                    alt={item.title}
                                ></img>
                            </div>
